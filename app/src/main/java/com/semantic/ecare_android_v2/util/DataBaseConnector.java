...
public class DataBaseConnector {
	...
	private class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			//patient
			try{
				String request="INSERT OR REPLACE INTO " + Constants.TABLE_PATIENT + " VALUES(1 ,'patient1', 1,'patient1', 'address1', 'patient1', '', 'Note pour patient 1', '2015-05-07 15:40:18.000')";
				db.execSQL(request);
				request="INSERT OR REPLACE INTO " + Constants.TABLE_PATIENT + " VALUES(2 ,'patient2', 1,'patient2', 'address2', 'patient2', '', 'Note pour patient 2', '2015-05-07 15:40:18.000')";
				db.execSQL(request);
				request="INSERT OR REPLACE INTO " + Constants.TABLE_PATIENT + " VALUES(3 ,'patient3', 1,'patient3', 'address3', 'patient3', '', 'Note pour patient 3', '2015-05-07 15:40:18.000')";
				db.execSQL(request);
			}catch(Exception e){
			...
			try{
				...
				db.execSQL(request);
				request="INSERT OR REPLACE INTO " + Constants.TABLE_CAPTEUR + " VALUES(6 ,18474, 'frequence cardiaque', 'xxxxxxxxx')";
				db.execSQL(request);
			...
			try{
				...
				db.execSQL(request);
				request="INSERT OR REPLACE INTO " + Constants.TABLE_MESURE + " VALUES(9 ,'patient1', 19384, 1427323334000, 97, 1, '', '')";
				db.execSQL(request);
